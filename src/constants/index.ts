...
export const samplecategories = [
  { id: 1, name: "Todos", icon: Sparkles, href: "/search?source=groups&category=todos" },
  {
    id: 2,
    name: "Nuevos Eventos",
    icon: UsersRound,
    href: "/search?source=groups&category=nuevos-eventos",
  },
  {
    id: 3,
    name: "Actividades sociales",
    icon: Pizza,
    href: "/search?source=groups&category=actividades-sociales",
  },
  {
    id: 4,
    name: "Aficiones",
    icon: Origami,
    href: "/search?source=groups&category=aficiones",
  },
  {
    id: 5,
    name: "Deportes",
    icon: Volleyball,
    href: "/search?source=groups&category=deportes",
  },
  {
    id: 6,
    name: "Viajes",
    icon: Plane,
    href: "/search?source=groups&category=viajes",
  },
  {
    id: 7,
    name: "Negocios",
    icon: BriefcaseBusiness,
    href: "/search?source=groups&category=negocios",
  },
  {
    id: 8,
    name: "Tecnología",
    icon: Computer,
    href: "/search?source=groups&category=tecnologia",
  },
  {
    id: 9,
    name: "Comunidad",
    icon: Earth,
    href: "/search?source=groups&category=comunidad",
  },
  {
    id: 10,
    name: "Juegos",
    icon: Gamepad2,
    href: "/search?source=groups&category=juegos",
  },
  {
    id: 11,
    name: "Baile",
    icon: BoomBox,
    href: "/search?source=groups&category=baile",
  },
  {
    id: 12,
    name: "Apoyo",
    icon: HeartCrack,
    href: "/search?source=groups&category=apoyo",
  },
  {
    id: 13,
    name: "Música",
    icon: Music2,
    href: "/search?source=groups&category=musica",
  },
];
